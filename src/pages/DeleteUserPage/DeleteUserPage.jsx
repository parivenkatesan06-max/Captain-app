...
import deleteLabels from "./DeleteUserPage.label.json"
import config from "./DeleteUserPage.config.json"
    ...
    const handleDelete = async () => {
        try {
            ...
            if (values) {
                ...
                const response = await signUpApiUtil.post(endPoints.deleteUser, {
                    email,
                    password,
                })
                ...
                <Flex vertical>
                    <Flex vertical>
                        <Breadcrumbs
                            ...
                            separator=">"
                        />
                        <Title level={2}>{deleteLabels?.pageTitle}</Title>
                    </Flex>
                        ...
                        <Col span={12} className={styles.formContainer}>
                            ...
                            >
                                <Button
                                    type="default"
                                    label={
                                        deleteLabels?.cancelButtonLabel
                                    }
                                ...
                                <Button
                                    type="primary"
                                    label={
                                        deleteLabels?.deleteButtonLabel
                                    }
